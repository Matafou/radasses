...
insert into households (id, name, trip_id) values
	('00000000-0000-0000-0000-0000000000f1', 'Dupont', '00000000-0000-0000-0000-0000000000e1'),
	('00000000-0000-0000-0000-0000000000f2', 'Zoé', '00000000-0000-0000-0000-0000000000e1');

insert into persons (id, name, trip_id) values
	('00000000-0000-0000-0000-0000000000a1', 'Alice', '00000000-0000-0000-0000-0000000000e1'),
	('00000000-0000-0000-0000-0000000000b2', 'Bob', '00000000-0000-0000-0000-0000000000e1'),
	('00000000-0000-0000-0000-0000000000c3', 'Chloé', '00000000-0000-0000-0000-0000000000e1'),
	('00000000-0000-0000-0000-0000000000d4', 'Zoé', '00000000-0000-0000-0000-0000000000e1');
...
insert into households (id, name, trip_id) values
	('00000000-0000-0000-0000-0000000000f5', 'David', '00000000-0000-0000-0000-0000000000e1');
insert into persons (id, name, trip_id) values
	('00000000-0000-0000-0000-0000000000d5', 'David', '00000000-0000-0000-0000-0000000000e1');
insert into trip_participants (trip_id, person_id, household_id, default_weight) values
...
insert into households (id, name, trip_id) values
	('00000000-0000-0000-0000-0000000000f3', 'Martin', '00000000-0000-0000-0000-0000000000e2'),
	('00000000-0000-0000-0000-0000000000f4', 'Sofia', '00000000-0000-0000-0000-0000000000e2');

insert into persons (id, name, trip_id) values
	('00000000-0000-0000-0000-0000000000a5', 'Marie', '00000000-0000-0000-0000-0000000000e2'),
	('00000000-0000-0000-0000-0000000000b6', 'Paul', '00000000-0000-0000-0000-0000000000e2'),
	('00000000-0000-0000-0000-0000000000c7', 'Sofia', '00000000-0000-0000-0000-0000000000e2');
